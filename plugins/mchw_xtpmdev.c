...
int mchw_xtpmdev_read( pwr_dev_t dev, PWR_AttrName attr, void *value, unsigned int len, PWR_Time *timestamp )
{
    return 0;
}

int mchw_xtpmdev_write( pwr_dev_t dev, PWR_AttrName attr, void *value, unsigned int len )
{
    return 0;
}
